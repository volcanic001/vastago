...
func TestMetricsResultsAndFuture(t *testing.T) {
	...
	for _, want := range []string{"15/01/2026", "RESUMEN", "Tiempo", "2h 00m", "Sesiones", "Pendientes hechos", "Habitos", "1/1 · 100%", "COMPARATIVA", "actual", "anterior", "TIEMPO POR TAREA", "Lectura", "▮"} {
